...
def stocks():
    ...
    p=figure(x_axis_type='datetime',width=1000,height=300,title="Stock Market Graph",sizing_mode="scale_width")
    ...
    return render_template("stocks.html",script1=script1,div1=div1,cdn_js=cdn_js[0],cdn_css=cdn_css[0])
